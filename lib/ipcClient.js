...
IPCClient = (function() {
  ...
  IPCClient.prototype.on = function(funcName, func) {
    return this.statelessCallbacks[funcName] = func;
  };
  ...
  IPCClient.prototype.onStatelessReply = function(parsedMessage) {
    var callback;
    return callback = this.statelessCallbacks[parsedMessage.func];
  };
  ...
  IPCClient.prototype.message = function(message) {
    ...
    } else if (this.statelessMessageTypes.indexOf(message.type) >= 0) {
